    ...
    return (
        <section id='transparent_pricing'>
            ...
            <div className='overlay div_1'>
                ...
                />
                <div className='text'>
                    <h4>C, C++, Core Java Course<br /><abbr className='indigo'>ESTIMATE PRICE</abbr></h4>
                    <Paragraph
            ...
            <div className='overlay div_2'>
                ...
                />
                <div className='text'>
                    <h4>Advanced Web Development Course<br /><abbr className='magenta'>ESTIMATE PRICE</abbr></h4>
                    <Paragraph
            ...
            <div className='overlay div_3'>
                ...
                />
                <div className='text'>
                    <h4>Python Development Course<br /><abbr className='indigo'>ESTIMATE PRICE</abbr></h4>
                    <Paragraph
