    ...
    return (
        <section id='pricing_page'>
            ...
            <div className='div div_2'>
                ...
                <Paragraph pText="" />
                <Paragraph pText=" Our Core .NET Programming Course is meticulously crafted to provide you with a solid foundation in the fundamental concepts and techniques of .NET development. Whether you're new to programming or looking to expand your skills, this course offers a comprehensive exploration of the core components of the .NET framework. By mastering essential programming principles and .NET technologies, you'll be well-equipped to build dynamic and scalable applications for a variety of platforms." />
            </div>
